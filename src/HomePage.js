...
import { HeroVideo, Button, ServiceCard, TimelineStep, ContentLab, TestimonialCarousel, Navbar, Footer, ChatWidget } from './components';
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section id="services" className="py-20 bg-gray-50 text-center">
        ...
        <Button variant="outline" size="lg" className="mt-8">Explore All Services</Button>
      </section>
      ...
      <section id="work" className="py-20 bg-white text-center">
        ...
        <div className="max-w-6xl mx-auto overflow-x-auto">
          <div className="flex space-x-6 px-4">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="relative w-64 h-40 bg-gray-200 rounded-lg shadow-lg group">
      ...
      <section id="process" className="py-20 bg-gray-50 text-center">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
          {processSteps.map((step, index) => (
            <TimelineStep key={index} title={step.title} description={step.description} />
          ))}
        </div>
      </section>
