    ...
    <div className="bg-gray-100 text-gray-900">
      ...
      <section className="px-4 py-16 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <p className="text-base leading-relaxed">
          At Social House, we deliver integrated digital marketing solutions that help modern brands grow. Our offerings are designed to build meaningful customer connections, increase ROI, and keep your brand ahead in a constantly evolving digital landscape.
        </p>
      </section>
